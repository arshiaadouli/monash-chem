...
from experiments.views import add_experiment, experiment_detail_delete, my_experiments, my_chemicals, my_equipment, add_equipment, add_supplier, experiment_detail
...
urlpatterns = [
    ...
    path('experiments/my_experiments/add', add_experiment, name="add_experiment"),
    path('experiments/my_experiments/<int:pk>', experiment_detail, name="experiment_detail"),
    ...
    path('experiments/my_experiment/delete/<int:path>', experiment_detail_delete, name="delete_experiment"),
    path('measurements/upload/<int:pk>', upload_file, name="upload_file"),
    path('measurements/delete', delete_file, name="delete_file"),
